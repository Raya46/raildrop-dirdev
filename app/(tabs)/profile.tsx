...
const Profile = () => {
  return (
    <SafeAreaView className="flex-1 flex flex-col bg-white justify-center">
      <View className="mx-4">
        <View className="flex flex-row items-center bg-[#D9E4F0] rounded-lg gap-10 py-3 border border-[#B0C8DF]">
        ...
        <View className="flex flex-col rounded-lg mt-4 p-4 bg-[#D9E4F0] border border-[#B0C8DF] gap-8">
          <View className="flex flex-row justify-between">
